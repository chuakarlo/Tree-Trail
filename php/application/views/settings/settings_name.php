...
<div class="form-group <?php echo ($first_name_error)?"has-error has-feedback":""; ?>">
	<label for="first_name" class="control-label text-muted"><strong>First Name</strong></label>
...
<div class="form-group <?php echo ($middle_name_error)?"has-error has-feedback":""; ?>">
	<label for="middle_name" class="control-label text-muted"><strong>Middle Name</strong></label>
...
<div class="form-group <?php echo ($last_name_error)?"has-error has-feedback":""; ?>">
	<label for="last_name" class="control-label text-muted"><strong>Last Name</strong></label>
